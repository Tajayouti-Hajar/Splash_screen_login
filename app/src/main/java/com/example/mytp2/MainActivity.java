...
public class MainActivity extends AppCompatActivity {
    ...
    public void Envoyer(View view){
        EditText usernametxt=(EditText)findViewById(R.id.editTextTextEmailAddress2);
        EditText passwordtxt=(EditText)findViewById(R.id.editTextTextPassword);

        TextView usernametv=(TextView)findViewById(R.id.textView3);
        TextView passwordtv=(TextView)findViewById(R.id.textView4);
